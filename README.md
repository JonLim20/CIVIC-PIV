...
Video guide: https://youtu.be/hvPrCUGzM2E

1. Create a Google Earth Eng2ine account and paste the following script into the analysis window. it is file S1 in the GitHub repository 
...
10.	 Clip the geometry using the Auto-clip tool provided in , to reduce the amount of area being analyzed. It also reprojects the image into a projected CRS of choice
